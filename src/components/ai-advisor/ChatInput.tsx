      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="bg-green-600 text-white px-3 sm:px-4 py-2.5 rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-400 transition flex items-center gap-2 min-h-[44px]"
            disabled={isLoading}
          ...
          <button
            ...
            className="bg-primary-600 text-white px-3 sm:px-4 py-2.5 rounded-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-400 transition min-h-[44px]"
