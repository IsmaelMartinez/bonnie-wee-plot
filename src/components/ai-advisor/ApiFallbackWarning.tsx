...
export default function ApiFallbackWarning({ reason }: ApiFallbackWarningProps) {
  ...
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-zen-lg p-4 mb-4">
      <div className="flex items-start gap-3">
        ...
        <button
          ...
          className="p-1 text-amber-600 hover:text-amber-800 hover:bg-amber-100 rounded transition flex-shrink-0"
          title="Dismiss"
