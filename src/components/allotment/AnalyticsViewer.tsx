    ...
    <div className="mt-4 space-y-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex items-center gap-2 px-4 min-h-[44px] text-sm bg-gray-100 text-gray-700 rounded-zen hover:bg-gray-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <button
          ...
          disabled={summary.totalEvents === 0}
          className="flex items-center gap-2 px-4 min-h-[44px] text-sm text-zen-kitsune-600 hover:bg-zen-kitsune-50 rounded-zen transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
