    ...
    <div className="mt-4 space-y-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 text-sm bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-300"
        >
        ...
        <button
          ...
          disabled={summary.totalEvents === 0}
          className="flex items-center gap-2 px-3 py-1.5 text-sm text-red-600 hover:bg-red-50 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed disabled:text-gray-400 disabled:bg-gray-100"
        >
