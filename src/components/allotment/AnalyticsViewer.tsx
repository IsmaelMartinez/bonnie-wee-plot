    ...
    <div className="mt-4 space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          disabled={summary.totalEvents === 0}
          className="flex items-center gap-2 px-4 min-h-[44px] text-sm text-red-600 hover:bg-red-50 rounded-zen transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
