...
export const vegetableIndex: VegetableIndex[] = [
  ...
  { id: 'potato', name: 'Potato', category: 'solanaceae' },
  ...
  { id: 'early-potato', name: 'First Early Potato', category: 'solanaceae' },
  { id: 'second-early-potato', name: 'Second Early Potato', category: 'solanaceae' },
  { id: 'maincrop-potato', name: 'Maincrop Potato', category: 'solanaceae' },
