...
export const berries: Vegetable[] = [
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [8, 11, 12], tip: 'Prune a third of the oldest wood to the ground after fruiting', category: 'care', stage: 'productive' },
      { months: [10, 11], tip: 'Take hardwood cuttings in autumn to raise new bushes', category: 'propagate' },
    ],
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [8, 9], tip: 'Prune fruited canes to the ground after harvest and tie in the new ones', category: 'care', stage: 'productive' },
    ],
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [8, 9], tip: 'Prune out the fruited canes after harvest and tie in the new growth', category: 'care', stage: 'productive' },
    ],
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [1, 2], tip: 'Prune out the oldest stems every few years in late winter, as little else is needed', category: 'care' },
