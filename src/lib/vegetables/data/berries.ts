...
export const berries: Vegetable[] = [
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [2, 8, 9], tip: 'Prune summer-fruiting canes to the ground after they crop and autumn-fruiting canes in late winter', category: 'care' },
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [11, 12], tip: 'Winter-prune established bushes, taking out a third of the oldest dark wood at the base', category: 'care' },
      { months: [10, 11], tip: 'Take hardwood cuttings in autumn to raise new bushes', category: 'propagate' },
    ],
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [8, 9], tip: 'Prune out the fruited canes at the base after harvest, leaving the fresh canes for next year', category: 'care' },
    ],
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [8, 9], tip: 'Prune out the canes that have just fruited, keeping the fresh new growth to carry next year crop', category: 'care' },
    ],
  ...
  },
  {
    ...
    careTips: [
      ...
      { months: [11, 12, 1, 2], tip: 'Prune out the oldest stems in winter to keep the shrub open, as it needs little other pruning', category: 'care' },
